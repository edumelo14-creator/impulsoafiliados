...
const RULES: CategoryRule[] = [
  ...
  },
  {
    ...
    exclude: ['teclado', 'mouse', 'hub usb', 'monitor', 'lampada led'],
  },
  {
  ...
  {
    category: 'Pet Shop',
    wholeWords: ['pet', 'cachorro', 'gato', 'gatos', 'cachorros'],
    keywords: ['cama pet', 'coleira', 'peitoral', 'pet shop', 'racao', 'ração',
      'arranhador', 'gaiola', 'aquario', 'aquário', 'aquario de peixe',
      'comedouro', 'bebedouro', 'brinquedo pet', 'ossinho', 'petisco',
      'tapete higienico', 'tapete higiênico', 'fralda pet', 'cama cachorro',
      'cama gato', 'casinha de cachorro', 'casinha', 'redes pet', 'pente pet',
      'escova pet', 'shampoo pet', 'vermifugo', 'vermífugo', 'antipulgas',
      'antipulga', 'coleira antipulgas', 'bolinha pet', 'brinquedo gato',
      'arranhador para gatos', 'arranhador para gato', 'ratinho pet',
    ],
  },
  {
